...
PROJECTS = [
    ...
    Project(['Peas', 'PeasGtk'], 'https://gitlab.gnome.org/GNOME/libpeas/raw/master/libpeas.doap'),
    Project(['CryptUI'], 'https://gitlab.gnome.org/GNOME/libcryptui/raw/master/libcryptui.doap'),
    Project(['DBus', 'DBusGLib', 'GIRepository', 'GL', 'cairo', 'fontconfig', 'freetype2', 'libxml2', 'win32', 'xfixes', 'xft', 'xlib', 'xrandr'], 'https://gitlab.gnome.org/GNOME/gobject-introspection/raw/master/gobject-introspection.doap'),
    Project(['EvinceDocument', 'EvinceView'], 'https://gitlab.gnome.org/GNOME/evince/raw/master/evince.doap'),
    ...
    Project(['Pango', 'PangoCairo', 'PangoFT2', 'PangoXft'], 'https://gitlab.gnome.org/GNOME/pango/raw/master/pango.doap'),
    ...
    Project(['Gdk', 'GdkX11', 'Gtk'], 'https://gitlab.gnome.org/GNOME/gtk/raw/master/gtk.doap'),
